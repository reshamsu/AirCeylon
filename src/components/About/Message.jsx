    ...
    <div className="about-message">
      <Container className="container">
        <div className="container-fluid">
          ...
          <p>
            I saw and experienced the challenges people face when navigating new
            journeys: visas, immigration, education, transitions, and the
          ...
          <p>
            At Air Ceylon, we are building more than a service. We’re building a
            bridge — between countries, between people, and between dreams and
            reality.“
          </p>
